...
def cmd_qr_check(args: argparse.Namespace) -> None:
    ...
    if not clean:
        ...
        print("\n  ENG OSON YO'L: brauzerda /admin/setup sahifasini oching va")
        print("  BotFather bergan tokenni qo'ying — nomni tizim o'zi aniqlaydi.")
        print("\n  Qo'lda qilmoqchi bo'lsangiz, yuqoridagi AYNAN SHU faylni")
        print("  tahrirlang — papka nusxalangan bo'lsa, boshqasini tahrirlash oson.")
